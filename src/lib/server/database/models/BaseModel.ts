...
export class BaseModel extends Model {
	static async getOne<M extends BaseModel>(
	...
	static async getAll<M extends BaseModel>(
		this: { new (): M } & typeof BaseModel,
		options?: FindOptions,
	): Promise<M[]> {
	...
	static async getById<M extends BaseModel>(
		this: { new (): M } & typeof BaseModel,
		id: Identifier,
	...
	static async createOne<M extends BaseModel>(
		this: { new (): M } & typeof BaseModel,
		values: any,
	...
	static async updateOne<M extends BaseModel>(
		this: { new (): M } & typeof BaseModel,
		values: any,
