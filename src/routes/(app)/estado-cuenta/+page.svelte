...
<div class="app">
  ...
  <div class="page-content" style="padding: 20px;">
    <div class="txn-list-wrap" style="margin: 0;">
      ...
      {:else}
        <div style="padding: 20px; text-align: center; color: var(--muted); font-size: 13px;">No hay movimientos registrados.</div>
      {/each}
    </div>
      ...
      <div class="pagination-footer">
        ...
        <div class="page-controls">
          {#if data.pagination.page > 1}
            <a href="?page=1&limit={data.pagination.limit}" class="page-btn" aria-label="First page" data-sveltekit-replacestate>
            ...
            <a href="?page={data.pagination.page - 1}&limit={data.pagination.limit}" class="page-btn" aria-label="Previous page" data-sveltekit-replacestate>
          ...
          {#if data.pagination.page < data.pagination.totalPages}
            <a href="?page={data.pagination.page + 1}&limit={data.pagination.limit}" class="page-btn" aria-label="Next page" data-sveltekit-replacestate>
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 18l6-6-6-6"/></svg>
            </a>
            <a href="?page={data.pagination.totalPages}&limit={data.pagination.limit}" class="page-btn" aria-label="Last page" data-sveltekit-replacestate>
...
<style>
  .txn-list-wrap { background: var(--surface); margin: 0 20px; border-radius: var(--r-md); padding: 4px 16px; border: 1px solid var(--border); }
  ...
  .page-info { font-weight: 500; color: var(--fg); }
  ...
  .page-btn.disabled { color: var(--border-strong); cursor: default; }
</style>
