<script lang="ts">
	...
	let canSubmit = $derived(
		isFirstNameValid && isLastNameValid && isDocumentValid && isPhoneValid && isEmailValid && isPasswordValid,
	);
</script>

<svelte:head>
	<title>{$page.data.appName} | Registro</title>
</svelte:head>
	...
	<header class="auth-hero">
		<div class="brand-mark light">
			<svg
				...
				class="svelte-1v2axqk"
				><path d="M12 2L2 7l10 5 10-5-10-5Z" class="svelte-1v2axqk"></path><path
					d="M2 17l10 5 10-5"
					class="svelte-1v2axqk"
				></path><path d="M2 12l10 5 10-5" class="svelte-1v2axqk"></path></svg
			>
